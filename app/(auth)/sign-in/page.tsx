            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-violet-650 hover:text-violet-550 dark:text-violet-450 dark:hover:text-violet-400 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer focus:outline-none select-none"
                >
